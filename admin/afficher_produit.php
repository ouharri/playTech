...
<div class="mainText" id="platType">
    <div class="add_prod">
        <h2><?= $row['libelle'] ?></h2>
        <h2 class="add-ntn"><a href="./admin/ajouter_produit.php?id=<?= $row['id_categorie'] ?>">Ajouter <i
                    class='bx bx-plus-circle add-cart add-cart-one'></i></a></h2>
    </div>
...
<div class="menu-content" id='plat'>
    ...
    <div class="mainText" id="platType">
        <div class="add_prod">
            <h2>Nos produit</h2>
            <h2 class="add-ntn"><a href="./admin/ajouter_produit.php?id=0">Ajouter <i
                        class='bx bx-plus-circle add-cart add-cart-one'></i></a></h2>
        </div>
        ...
        <div class="roW">
            ...
            <div class="foteerPlat">
                <div class="addPlat">
                    ...
                    <a href="./admin/supprimer_produit.php?id=<?= $row['id_produit'] ?>"><i
                            class='bx bxs-trash-alt'></i></a>
                </div>
            </div>
        </div>
        <?php
        supp('supp',$row['libelle_produit'],'#',$row['id_produit']);
        }
        }
